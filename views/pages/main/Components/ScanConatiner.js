...
export default function ScanConatiner(props) {
                ...
                imageUri ?
                    <View style={{ flex: 1 }} >
                        ...
                        <View style={{ position: "absolute", bottom: 40, display: "flex", flexDirection: "row", width: "100%", justifyContent: "flex-end", alignItems: "center" }}>
                            ...
                            <TouchableOpacity style={{ marginRight: "17%" }} onPress={() => { props.navigation.navigate("SignatureScreen") }}>
                        ...
                        <View style={styles.buttonContainer}>
                            ...
                            <View style={{ position: "absolute", bottom: 30, display: "flex", flexDirection: "row", width: "100%", justifyContent: "center", alignItems: "center" }}>
                                ...
                                <TouchableOpacity onPress={takePicture}>
                                    <Image source={require("../../../Image/capture.png")} style={{
                                        height: 80, width: 80,
                                        // marginHorizontal: "15%"
                                    }} />
                                </TouchableOpacity>
